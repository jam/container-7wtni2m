...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-7wtni2m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-7wtni2m.containers.anotherwebservice.com/
...
```
git clone git@github.com:jam/container-7wtni2m.git
cd container-7wtni2m
```
...
```
docker attach container-7wtni2m
```
